...
- Сроки/места/вуз во всех 4 резюме = этот канон (синк@2026-07-20). Отличие head-ru: +ФБК
  (2018-05→2018-08, «ИТ консультант», перекрывается с Genestack) — юзер не решил, оставлен.
