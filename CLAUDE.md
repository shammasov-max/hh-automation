...
│                      #   новые записи создают apply.py / hh-test-apply, обновления — ТОЛЬКО src/applied_log.py;
...
- Троттлинг: scan 1.5с/страница, fetch 1.2с/вакансия, apply 8с/отклик, inbox 1.5с/страница + 1с/чат. Не ужимать.
